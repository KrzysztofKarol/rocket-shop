...
var Assignment = function (args) {
    ...
    this.passengerIsCompatible = function () {
        ...
        if(this.role === "commander") {
            ...
            valid = this.passenger.age > 35 && this.passenger.age < 75 &&
                this.passenger.weight < 250 &&
                this.passenger.height < 84;
        } else if(this.role === "mav-pilot") {
            // MAVs are small
            // age between 35 and 75, weight under 180, height under 6 feet
            valid = this.passenger.age > 35 && this.passenger.age < 75 &&
            ...
            valid = this.mission.totalWeight < 1400 &&
                this.passenger.age > 35 && this.passenger.age < 55 &&
